...
### 📚 阅读
- **多格式**：EPUB / PDF / TXT / DOCX / MOBI 统一阅读体验。PDF 走 pdf.js，其余统一抽出 HTML + 文本喂渲染器。MOBI 不支持 DRM 加密 / KF8-only。
...
- 书、笔记、聊天记录、音乐索引**全部存本地**：`%APPDATA%/com.aireader.app/`。
